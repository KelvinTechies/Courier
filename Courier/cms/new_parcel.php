        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <input type="text" name="country" id="" class="form-control form-control-sm" placeholder='Enter Country' value="<?php echo isset($country) ? $country :'' ?>" required>
              </div>
             <div class="form-group">
                <label for="" class="control-label">Latitude</label>
                <input type="text" name="latitude" id="" class="form-control form-control-sm" placeholder='Enter your Latitude' value="<?php echo isset($latitude) ? $latitude :'' ?>" required>
              </div>
              <div class="form-group">
                <label for="" class="control-label">Longitude</label>
                <input type="text" name="longitude" id="" class="form-control form-control-sm" placeholder='Enter your longitude' value="<?php echo isset($longitude) ? $longitude :'' ?>" required>
              </div>
              <div class="form-group">
                <label for="" class="control-label">Means Of Transportation</label>
                <input type="text" name="transportation" id="" class="form-control form-control-sm" placeholder='Air, Ocean, Airport, Custom' value="<?php echo isset($Transportation) ? $Transportation :'' ?>" required>
              </div>
          </div>
          <div class="col-md-6" id=""  <?php echo isset($type) && $type == 1 ? 'style="display: none"' : '' ?>>
          <div class="form-group" >
                <label for="" class="control-label">Delivery Date</label>
                <input type="date" name="pickup" id="" class="form-control" value='<?php echo isset($pickup) ? $pickup :'' ?>'>
             
            </div>
              <div class="form-group" >
                <label for="" class="control-label">Product</label>
                <textarea name="from_branch_id" id="from_branch_id" class="form-control" value="<?php echo isset($from_branch_id) ? $from_branch_id :'' ?>" required="">
        ...
        <table class="table table-bordered" id="parcel-items">
          ...
          <tbody>
            <tr>
              ...
              <td><input type="date" name='length[]' value="<?php echo isset($length) ? $length :'' ?>" required></td>
