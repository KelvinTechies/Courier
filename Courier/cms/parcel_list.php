			...
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center">
		                    <div class="btn-group">
		                    	<button type="button" class="btn btn-info btn-flat view_parcel" data-id="<?php echo $row['reference_number'] ?>">
		                          <i class="fas fa-eye"></i>
		                        </button>
								<a href="print_parcel.php?id=<?php echo $row['reference_number'] ?>" type="button" class="btn btn-warning btn-flat print_parcel">
